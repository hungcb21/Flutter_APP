...
class Update_Info_Own extends StatefulWidget {
  @override
  _Update_Info_OwnState createState() => _Update_Info_OwnState();
}

class _Update_Info_OwnState extends State<Update_Info_Own> {
  ...
  void initState() {
    ...
    var uid = user.uid;
    DatabaseReference databaseReference= FirebaseDatabase.instance.reference().child("Onwners");
