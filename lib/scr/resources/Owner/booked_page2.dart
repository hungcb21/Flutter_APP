...
class _BookedPageState extends State<BookedPage> {
  ...
  void initState() {
    ...
    DatabaseReference reference= FirebaseDatabase.instance.reference().child("Stores").child(uid).child("Time").child('time');
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        bottom: AppBar(
          backgroundColor: Colors.yellow,
          title: Text("Booked",style: TextStyle(fontSize: 30,color: Colors.black),),
        ),
      ),
        body: Center(
          child: Container(
