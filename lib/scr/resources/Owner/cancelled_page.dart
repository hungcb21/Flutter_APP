...
class _CancelledState extends State<Cancelled> {
  ...
  void initState() {
    ...
    DatabaseReference reference= FirebaseDatabase.instance.reference().child("Stores").child(uid).child("Cancel");
    query=  FirebaseDatabase.instance.reference().child("Stores").child(uid).child("Cancel");
                            ...
                            Row(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(snapshot.value["Date"]+" "+snapshot.value["Time"],style: TextStyle(fontSize: 15)),
                                ),
                              ],
                            ),
                            Row(
