...
class _SignUpState extends State<SignUp> {
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: new Image.asset(
                                    "images/undraw_sign_in_e6hj (1) 1.png"),
                              ),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  new Image.asset(
                                      "images/Welcome to Booking Barbershop App.png")
                                ],
                              ),
                              Padding(
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                      child:
                                          new Image.asset("images/call 1.png")),
                                  Container(
                                      width: 300,
                                      child: StreamBuilder(
  ...
  _onSignUpClicked() {
    ...
    if (isValid) {
      ...
      bloc.signUp(_userController.text, _passController.text,
          _phoneController.text, _nameController.text, () {
